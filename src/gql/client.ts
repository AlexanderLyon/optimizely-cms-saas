		...
		content: _Content(
			where: {
				_or: [
					...
					{
						_metadata: {
							url: { hierarchical: { eq: $path }, base: { eq: $domain } }
							version: { eq: $version }
						}
					}
				]
...
export const getDictionaryDocument = /*#__PURE__*/ gql`
	query getDictionary($dictionary: String!, $locale: [Locales]) {
		getDictionary: Dictionary(where: { DictionaryKey: { eq: $dictionary } }, locale: $locale) {
			total
			items {
				key: DictionaryKey
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
	return {
		getContentType(
			...
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getContentTypeQuery>(getContentTypeDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getContentType',
		...
		getContentById(
			...
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getContentByIdQuery>(getContentByIdDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getContentById',
		...
		getArticleListElementItems(
			variables?: Schema.getArticleListElementItemsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getArticleListElementItemsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getArticleListElementItemsQuery>(
						getArticleListElementItemsDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getArticleListElementItems',
		...
		getBlankExperienceMetaData(
			variables: Schema.getBlankExperienceMetaDataQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getBlankExperienceMetaDataQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getBlankExperienceMetaDataQuery>(
						getBlankExperienceMetaDataDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getBlankExperienceMetaData',
		...
		getArticleGroupPageItems(
			variables: Schema.getArticleGroupPageItemsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getArticleGroupPageItemsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getArticleGroupPageItemsQuery>(
						getArticleGroupPageItemsDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getArticleGroupPageItems',
		...
		getArticlePageMetaData(
			variables: Schema.getArticlePageMetaDataQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getArticlePageMetaDataQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getArticlePageMetaDataQuery>(
						getArticlePageMetaDataDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getArticlePageMetaData',
		...
		getFooter(
			variables?: Schema.getFooterQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getFooterQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getFooterQuery>(getFooterDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getFooter',
		...
		getHeader(
			variables?: Schema.getHeaderQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getHeaderQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getHeaderQuery>(getHeaderDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getHeader',
		...
		getDictionary(
			variables: Schema.getDictionaryQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<Schema.getDictionaryQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<Schema.getDictionaryQuery>(getDictionaryDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders,
					}),
				'getDictionary',
